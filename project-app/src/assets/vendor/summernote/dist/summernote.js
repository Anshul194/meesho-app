  ...
  "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ? module.exports = a(require("jquery")) : a(window.jQuery)
    ...
    var Renderer = function(a, b, c, d) {
            this.render = function(e) {
                var f = $(a);
                if (c && c.contents && f.html(c.contents), c && c.class && f.addClass(c.class), c && c.data && $.each(c.data, function(a, b) {
                        f.attr("data-" + a, b)
        ...
        dropdownCheck = renderer.create('<div class="dropdown-menu note-check">', function(a, b) {
            var c = $.isArray(b.items) ? b.items.map(function(a) {
                var c = "string" == typeof a ? a : a.value || "",
                    d = b.template ? b.template(a) : a;
                return '<li><a href="#" data-value="' + c + '">' + icon(b.checkclass) + " " + d + "</a></li>"
            }).join("") : b.items;
            a.html(c)
        }),
    ...
    var key = function() {
        ...
        Table = function() {
            this.tab = function(a, b) {
                ...
                g = h.join("");
                var j = $("<table>" + g + "</table>");
                return c && c.tableclass && j.addClass(c.tableclass), j[0]
            }
        },
        KEY_BOGUS = "bogus",
        Editor = function(a) {
            ...
            this.initialize = function() {
                ...
                a.memo("button.style", function() {
                    ...
                    return c.buttonGroup([c.button({
                        ...
                        class: "dropdown-fontname",
                        checkclass: e.icons.menuCheck,
                    ...
                    return c.buttonGroup({
                        class: "note-color",
                        children: [c.button({
                            class: "note-current-color-button",
    ...
    $.summernote = $.extend($.summernote, {
        ...
        options: {
            ...
            fontNames: ["Arial", "Arial Black", "Comic Sans MS", "Courier New", "Helvetica Neue", "Helvetica", "Impact", "Iconica Grande", "Tahoma", "Times New Roman", "Verdana"],
